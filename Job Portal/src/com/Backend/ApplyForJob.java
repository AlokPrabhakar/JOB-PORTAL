    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(i>0)
            {
                ...
                System.out.println("from apply :"+id);
                RequestDispatcher rd2=req.getRequestDispatcher("my-applied-jobs.jsp?id="+id);
            ...
            else
            {
                ...
                rd1.include(req, resp);
                RequestDispatcher rd2=req.getRequestDispatcher("job-description.jsp?jid="+id);
                rd2.include(req, resp);
            }
        }
        catch(Exception e)
