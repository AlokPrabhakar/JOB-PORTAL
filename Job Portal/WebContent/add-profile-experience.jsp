                ...
                <div class="row" style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="AddExperienceDetails" method="POST">
							...
							<div class="col-8">
								<input type="text" class="form-control" id="Xpercent" name="company1">
							</div>
						</div>
                          <div class="mb-3 pb-2 row">
							<div class="col-4">
							...
							<div class="col-8">
								<input type="text" class="form-control" id="Xpercent" placeholder="eg. JAVA Devloper ,Python Devloper" name="title1">
							</div>
						</div>
                         <div class="mb-3 pb-2 row">
							<div class="col-4">
							...
							<div class="col-8">
								<input type="text" class="form-control" id="Xpercent" placeholder="e g.  2001-2004"  name="year1">
							</div>
						</div>
						 <div class="mb-3 pb-2 row">
							<div class="col-4">
							...
							<div class="col-8">
								<input type="text" class="form-control" id="Xpercent" placeholder="like Banglore,.. "  name="location1">
							</div>
						</div>
						<div class="mb-3 pb-2 row">
							<div class="col-4">
							...
							<div class="col-8">
								<input type="text" class="form-control" id="Xpercent" placeholder="eg. JOB PORTAL.. "  name="project1">
							</div>
						</div>
						  <div class="mb-3 pb-2 row">
							<div class="col-4">
							...
							<div class="col-8">
								<textarea placeholder="Project Description" name="description1" style="padding: 5px 10px; width: 280px; height: 100px; border-radius: 5px; border: 1px solid gray;"></textarea> 
							</div>
						</div>
