				...
				<div class="col-md-6" style="background-color: #f9f8f9; margin-top: 10px">
                        ...
                        <jsp:scriptlet>
                            ...
                            <div class="col-md-12 display_job_div">
                            	...
                            	<span class="glyphicon glyphicon-home pe-4"></span> <span style="color: #9f9d9d"> Company : </span> <jsp:expression>company</jsp:expression> </span> <br>
                                <span> <span class="glyphicon glyphicon-book pe-4"></span> <span style="color: #9f9d9d"> Experience : </span> <jsp:expression>experience</jsp:expression> </span> <br>
                                <span> <span class="glyphicon glyphicon-file pe-4"></span>  <span style="color: #9f9d9d"> Job Description : </span> <jsp:expression>description</jsp:expression> </span> <br>
